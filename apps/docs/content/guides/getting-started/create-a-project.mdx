...
description: "Before working with Supabse, you need to create a project. You can do this visually in the Dashboard or programmatically using the Management API."
---
