...
{/* TODO: temporary — troubleshooting AI prompt panel styling inline; move back to ai/quickstart_prompt_panel.mdx when done */}

<GlassPanel
  className="not-prose bg-brand-300/5 dark:bg-brand/5 border-brand/30 dark:border-brand-500/30 [&>div]:gap-0 [&>div]:px-4 [&>div]:pl-6 [&>div]:pb-0 [&>div]:pt-4 [&>div>span]:block [&>div>span]:ml-6 [&_.shiki]:!bg-transparent [&_.shiki]:!rounded-none [&_.shiki]:!border-t-0 [&_.shiki]:!border-r-0 [&_.shiki]:!border-b-0 [&_.shiki]:!border-l-[5px] [&_.shiki]:!border-l-brand/30 dark:[&_.shiki]:!border-l-brand-500/30 [&_.shiki_.select-none]:!hidden [&_.shiki_code]:!grid-cols-1 [&_.shiki_code>div:nth-child(2n)]:!pr-4"
  title="For AI agents"
