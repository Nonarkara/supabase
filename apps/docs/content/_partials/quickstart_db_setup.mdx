...
For this, copy and run the snippet below in your project's [SQL Editor](/dashboard/project/_/sql/new) or <a href={`/dashboard/project/_/sql/new?content=${encodeURIComponent(sqlSetup)}`}>click here to prefill the SQL</a> and then execute it.
